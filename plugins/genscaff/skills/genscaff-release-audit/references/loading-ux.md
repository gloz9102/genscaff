...
Use this whenever the audited surface reads remote data, submits data, streams results, lazy-loads media, waits on navigation, or starts a long-running job. A spinner is not a loading strategy.
